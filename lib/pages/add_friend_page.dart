...
class AddFriendPage extends StatelessWidget {
  ...
  final AddFriendListController _friendController = Get.put(AddFriendListController());
          ...
          children: [
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  child: Text("搜索"),
                  onPressed: () => _friendController.searchUserList(),
                )
              ],
            ),
            SizedBox(height: 10),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              await _friendController.addFriend(userModel.id);
